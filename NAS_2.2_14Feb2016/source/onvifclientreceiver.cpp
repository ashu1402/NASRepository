...
int OnvifClientReceiver::GetReceiver(_trv__GetReceiverResponse &receiverResponse, string ReceiverToken)
{
...
OnvifClientReceiver::OnvifClientReceiver(OnvifClientDevice &device)
: m_Device(device), receiverProxy(SOAP_C_UTFSTRING)
{

}

OnvifClientReceiver::~OnvifClientReceiver()
{
