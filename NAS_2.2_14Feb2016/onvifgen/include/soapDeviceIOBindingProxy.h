...
{ public:
	...
	virtual	int GetAudioSources(const char *endpoint, const char *soap_action, tmd__Get *tmd__GetAudioSources, tmd__GetResponse &tmd__GetAudioSourcesResponse);
	...
	virtual	int GetAudioOutputs(const char *endpoint, const char *soap_action, tmd__Get *tmd__GetAudioOutputs, tmd__GetResponse &tmd__GetAudioOutputsResponse);
	...
	virtual	int GetVideoSources(const char *endpoint, const char *soap_action, tmd__Get *tmd__GetVideoSources, tmd__GetResponse &tmd__GetVideoSourcesResponse);
	...
	virtual	int GetDigitalInputConfigurationOptions(const char *endpoint, const char *soap_action, _tmd__GetDigitalInputConfigurationOptions *tmd__GetDigitalInputConfigurationOptions, _tmd__GetDigitalInputConfigurationOptionsResponse &tmd__GetDigitalInputConfigurationOptionsResponse);
	...
	virtual	int SetDigitalInputConfigurations(const char *endpoint, const char *soap_action, _tmd__SetDigitalInputConfigurations *tmd__SetDigitalInputConfigurations, _tmd__SetDigitalInputConfigurationsResponse &tmd__SetDigitalInputConfigurationsResponse);
