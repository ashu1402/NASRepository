...
{ public:
	...
	virtual	int ExportRecordedData(const char *endpoint, const char *soap_action, _trc__ExportRecordedData *trc__ExportRecordedData, _trc__ExportRecordedDataResponse &trc__ExportRecordedDataResponse);
	...
	virtual	int StopExportRecordedData(const char *endpoint, const char *soap_action, _trc__StopExportRecordedData *trc__StopExportRecordedData, _trc__StopExportRecordedDataResponse &trc__StopExportRecordedDataResponse);
	...
	virtual	int GetExportRecordedDataState(const char *endpoint, const char *soap_action, _trc__GetExportRecordedDataState *trc__GetExportRecordedDataState, _trc__GetExportRecordedDataStateResponse &trc__GetExportRecordedDataStateResponse);
};
#endif
