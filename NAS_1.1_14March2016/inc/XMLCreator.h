...
public:
	...
	void NewSuccessDeviceInfoAction( int DID,char *macAddress, char * deviceName);
	...
	void NewDeviceInfo(	const char* DID,const char* DName,const char* DeviceIP,const char* Status,const char* Owner,const char*  MacAddress);
