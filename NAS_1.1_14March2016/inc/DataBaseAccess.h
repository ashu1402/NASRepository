...
public:
	...
	int InsertDeviceInfo(int DID, char* DeviceName, char *DeviceIP,int Status,int Owner,char* MacId);
...
//	int InsertchannelCGroupRelation(int CID,int CGID,int DID,int UID);
	...
	void GetAllDeviceInfo( vector<string> *DID,vector<string> *DName,vector<string> *DeviceIP,vector<string> *Status,vector<string> *Owner,vector<string> *MacAddress, bool withOweres);
	...
	int UpdateDeviceInfo(char* DID,char* DeviceName, char *DeviceIP,char* Status);
	...
	//bool GetAllAvailableNASDetail(vector<string>& );
    ...
    bool GetDeviceInfo(char * deviceName,char * deviceip, int &DID, char *macAddress);
	bool GetDeviceDetails( vector<int> &DID,vector<string> &macAddress,vector<string> &DeviceIP, vector<int> &status,vector<string> &deviceName);
