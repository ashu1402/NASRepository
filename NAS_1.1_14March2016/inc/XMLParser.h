...
public:
	...
	bool GetDeviceInfo(int &enteredDeviceID,char *macValue, char * DeviceIP, int sockFD,char *deviceName);
	bool DeviceInfo(xml_node<>* node);
	bool ParseDeviceInfo(char *macValue, int &enteredDeviceID,char *xmlData, char * deviceName);
