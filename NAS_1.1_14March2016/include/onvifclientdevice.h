...
public:
	...
	int SetDNS(_tds__SetDNSResponse &SetDNSResponse, bool FromDHCP, vector<string> SearchDomain, vector<tt__IPAddress*> &DNSManual);
	int GetNTP(_tds__GetNTPResponse &GetNTPResponse);
	int SetNTP(_tds__SetNTPResponse &SetNTPResponse, bool FromDHCP, vector<tt__NetworkHost*> &NTPManual);
	...
	int SetNetworkProtocols(_tds__SetNetworkProtocolsResponse &SetNetworkProtocolsResponse,vector<tt__NetworkProtocol*> &NetworkProtocols);
	int GetNetworkDefaultGateway(_tds__GetNetworkDefaultGatewayResponse &GetNetworkDefaultGatewayResponse);
	int SetNetworkDefaultGateway(_tds__SetNetworkDefaultGatewayResponse &SetNetworkDefaultGatewayResponse,vector<string> &IPv4,vector<string> &IPv6);
